      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="bg-zinc-50 dark:bg-zinc-900 p-10 rounded-[2.5rem] border border-zinc-100 dark:border-zinc-800 transition-all hover:shadow-2xl hover:shadow-zinc-200/50 dark:hover:shadow-none group">
            <div className="w-16 h-16 bg-zinc-900 dark:bg-zinc-100 rounded-2xl flex items-center justify-center mb-8 rotate-3 group-hover:rotate-0 transition-transform duration-500 opacity-0 animate-reveal reveal-delay-1">
            ...
            <h3 className="text-2xl font-black mb-4 text-zinc-900 dark:text-zinc-100 opacity-0 animate-reveal reveal-delay-1">Missão</h3>
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium opacity-0 animate-reveal reveal-delay-2">
              {data.missao}
            </p>
          </div>
          ...
          <div className="bg-zinc-50 dark:bg-zinc-900 p-10 rounded-[2.5rem] border border-zinc-100 dark:border-zinc-800 transition-all hover:shadow-2xl hover:shadow-zinc-200/50 dark:hover:shadow-none group">
            ...
            <h3 className="text-2xl font-black mb-4 text-zinc-900 dark:text-zinc-100 opacity-0 animate-reveal reveal-delay-1">Visão</h3>
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium opacity-0 animate-reveal reveal-delay-2">
              {data.visao}
            </p>
          </div>
          ...
          <div className="bg-zinc-900 dark:bg-zinc-100 p-10 rounded-[2.5rem] transition-all hover:shadow-2xl hover:shadow-zinc-900/20 group">
            <div className="w-16 h-16 bg-white dark:bg-zinc-900 rounded-2xl flex items-center justify-center mb-8 rotate-6 group-hover:rotate-0 transition-transform duration-500 opacity-0 animate-reveal reveal-delay-1">
            ...
            <h3 className="text-2xl font-black mb-4 text-white dark:text-zinc-900 opacity-0 animate-reveal reveal-delay-1">Valores</h3>
            <ul className="space-y-3 opacity-0 animate-reveal reveal-delay-2">
